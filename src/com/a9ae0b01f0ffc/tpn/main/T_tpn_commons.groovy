...
class T_tpn_commons extends T_common_commons{
    ...
    String GC_MAIN_POLL_INTERVAL_MILLISECONDS = 2000
    ...
    T_tpn_commons(String i_conf_file_name) {
        ...
        GC_MAIN_POLL_INTERVAL_MILLISECONDS = GC_CONST_CONF.GC_MAIN_POLL_INTERVAL_MILLISECONDS(GC_MAIN_POLL_INTERVAL_MILLISECONDS)
